...
\begin{document}
    ...
    % TODO: In a group expressed as a product of cyclic groups of prime power order, we counted number of elements or order dividing a certain prime power.

    % Discussed and showed that every finitely generated abelian group is the quotient of Zn/Zm for some m ≤ n.

    % TODO: Smith Normal Form
